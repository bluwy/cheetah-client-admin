<template>
  <v-app>
    <v-app-bar app elevation="0">
      ...
      <v-spacer></v-spacer>
      <v-btn class="mr-2" large text to="jobs">Jobs</v-btn>
      <v-btn class="mr-2" large text to="customers">Customers</v-btn>
      <v-menu offset-y>
        ...
        <v-list dense>
          <v-list-item v-if="isPrivilegeFull" to="staffs">
            <v-list-item-icon>
          ...
          <v-list-item v-if="isPrivilegeFull" to="admins">
            <v-list-item-icon>
